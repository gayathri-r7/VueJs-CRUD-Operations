...
import (
	...
	// . "github.com/mlabouardy/User-BackEnd/config"
	// . "github.com/mlabouardy/User-BackEnd/dao"
	// . "github.com/mlabouardy/User-BackEnd/models"
...
func DeleteUserEndPoint(w http.ResponseWriter, r *http.Request) {
	...
	respondWithJson(w, http.StatusOK, map[string]string{"result": "User Deleted Successfully"})
}
